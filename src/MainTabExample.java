...
/*
 * Creating and using MainTabExample example  
 */
public class MainTabExample extends JFrame {    
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable(){
            ...
            UIManager.put("swing.boldMetal", Boolean.FALSE);
                new MainTabExample("MainTabExample").runTest();
            }
        });
    }
     
    public MainTabExample(String title) {
        super(title);
